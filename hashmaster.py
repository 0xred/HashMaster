...
def menu():
    print(" [1] MD5 Cracked ")
    print(" [2] HASH ID ")
    print(" [3] Generate Hash MD5 & SHA1 & SHA256 ")
    print(" [4] Brute Force MD5 ")
    print(" [5] Brute Force SHA1 ")
...
def option1():
    ...
    if int is 32:
            ...
            time.sleep(1)
#############################################
# this founction from Hash Identifier By Zion3R
...
def option3():
    ...
    for i in range(3):
        setpass = bytes(sss, 'utf-8')
    hash_object = hashlib.sha384(setpass)
    sha384hash = hash_object.hexdigest()
    ...
    print('\033[1;96m'" SHA384 hash ======> "'\033[1;92m'+sha384hash)
    print('\033[1;96m'" <<================<< Finish >>===================>>")
    print("")
    backmenu = input(" Press Enter To Back Menu >>>")
    if backmenu == "":
